...
document.getElementById("getFile").onchange = function(){
      ...
      function wordCloud(sourceText){
           ...
           //remove non letters, keep letters, whitespace
           let alphaRedx = /[^a-zA-Z\s]/g;
           sourceText = sourceText.replace(alphaRedx, "");
           ...
           words.sort();
           //2-D array contains each unique words its count
